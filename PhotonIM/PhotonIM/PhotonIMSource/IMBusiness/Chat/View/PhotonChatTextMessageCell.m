...
@interface PhotonChatTextMessageCell()
@property(nonatomic, strong, nullable)UILabel  *textMessageLabel;
@end

@implementation PhotonChatTextMessageCell
...
- (void)setObject:(id)object{
    ...
    PhotonChatTextMessageItem *item = (PhotonChatTextMessageItem *)object;
...
- (void) p_layoutSubviews{
    PhotonChatTextMessageItem *item = (PhotonChatTextMessageItem *)self.item;
